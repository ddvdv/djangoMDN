# Generated by Django 2.1.1 on 2018-09-12 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(help_text='Enter a brief description a the book', max_length=1000)),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique ID for this particuliar book across whole library', primary_key=True, serialize=False)),
